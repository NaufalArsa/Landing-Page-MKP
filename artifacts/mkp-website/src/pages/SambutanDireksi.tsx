    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-secondary pt-32 pb-16 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10"
          style={{ backgroundImage: "radial-gradient(circle at 20% 50%, #01B1D7 0%, transparent 60%), radial-gradient(circle at 80% 50%, #337AB7 0%, transparent 60%)" }}
        />
          ...
          <div className="flex flex-col lg:flex-row gap-14 items-start">
            ...
            >
              <div className="relative">
                ...
                <div className="mt-5 bg-secondary rounded-xl p-5 text-white text-center shadow-lg">
                  <div className="font-bold text-lg leading-tight">Direktur Utama</div>
                  <div className="text-accent text-sm font-semibold mt-1">PT Mitra Karya Prima</div>
                </div>
                {/* Decorative accent */}
            ...
            >
              ...
              >
                ...
                <div>
                  <div className="font-bold text-secondary text-lg">Direktur Utama</div>
                  <div className="text-sm text-gray-500">PT Mitra Karya Prima</div>
                </div>
              </motion.div>
            </motion.div>
