...
import { ScrollText, Loader2, ZoomIn } from "lucide-react";
...
export default function GCG() {
  const [data, setData] = useState<GcgData | null>(null);
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center gap-2 text-accent/80 text-sm font-medium mb-3">
              ...
              <span>/</span>
              <span className="text-white">GCG</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-extrabold text-white">Good Corporate Governance</h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-gray-400">
              ...
              <p className="text-lg font-medium">Bagan GCG belum tersedia</p>
              <p className="text-sm mt-1 text-center">
                Bagan GCG akan ditampilkan di sini setelah diunggah oleh admin.
              </p>
            </div>
          ) : (
            <motion.div
